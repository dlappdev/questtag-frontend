...
BFHCurrencies.prototype = {
    ...
    addBootstrapCurrencies: function () {
        ...
        console.log("bootstrap currencies");
        var $input,
            $toggle,
            $options,
            value,
        ...
        if (this.options.blank === true) {
            $options.append('<li><a id="currerncyShown" tabindex="-1" href="javascript:void(0)" data-option=""></a></li>');
        }
        ...
        for (currency in currencies) {
            if (currencies.hasOwnProperty(currency)) {
                if (this.options.flags === true) {
                    ...
                    $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="' + currency + '" data-symbol="' + currencies[currency].symbol + '"><i class="glyphicon bfh-flag-' + flag + '"></i>' + currencies[currency].label + '<span> </span> (' + currencies[currency].symbol + ')</a></li>');
