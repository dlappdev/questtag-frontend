...
+function ($) {
  ...
  BFHCountries.prototype = {
    ...
    addBootstrapCountries: function() {
      ...
      if (this.options.blank === true) {
        $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option=""></a></li>');
      }

      for (country in countries) {
        if (countries.hasOwnProperty(country)) {
          if (this.options.flags === true) {
            $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="' + country + '"><i class="glyphicon bfh-flag-' + country + '"></i>' + countries[country] + '</a></li>');
          } else {
            $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="' + country + '">' + countries[country] + '</a></li>');
          }
        }
      }
      ...
      for (currency in currencies) {
        if (currencies.hasOwnProperty(currency)) {
          if (this.options.flags === true) {
            ...
            $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="' + currency +  '" data-symbol="'+currencies[currency].symbol+'"><i class="glyphicon bfh-flag-' + flag + '"></i>' + currencies[currency].label +' ('+currencies[currency].symbol+ ')</a></li>');

          } else {
            $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="' + currency + '">' + currencies[currency].label + '</a></li>');
          }
        }
      }
  ...
  BFHDatePicker.prototype = {
    ...
    initCalendar: function() {
      ...
      this.$element.html(
        ...
        '<a class="previous" href="javascript:void(0)"><i class="glyphicon glyphicon-chevron-left"></i></a>' +
        '<span></span>' +
        '<a class="next" href="javascript:void(0)"><i class="glyphicon glyphicon-chevron-right"></i></a>' +
        '</th>' +
...
+function ($) {
  ...
  BFHFonts.prototype = {
    ...
    addBootstrapFonts: function() {
      ...
      for (font in fonts) {
        if (fonts.hasOwnProperty(font)) {
          $options.append('<li><a tabindex="-1" href="javascript:void(0)" style=\'font-family: ' + fonts[font] + '\' data-option="' + font + '">' + font + '</a></li>');
        }
      }
...
+function ($) {
  ...
  BFHFontSizes.prototype = {
    ...
    addBootstrapFontSizes: function() {
      ...
      for (fontsize in fontsizes) {
        if (fontsizes.hasOwnProperty(fontsize)) {
          $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="' + fontsize + '">' + fontsizes[fontsize] + '</a></li>');
        }
      }
...
+function ($) {
  ...
  BFHGoogleFonts.prototype = {
    ...
    addBootstrapFonts: function() {
      ...
      if (this.options.blank === true) {
        $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="" style="background-image: none;"></a></li>');
      }

      for (font in fonts) {
        if (fonts.hasOwnProperty(font)) {
          $options.append('<li><a tabindex="-1" href="javascript:void(0)" style="background-position: 0 -' + ((fonts[font].index * 30) - 2) + 'px;" data-option="' + fonts[font].info.family + '">' + fonts[font].info.family + '</a></li>');
        }
      }
    ...
    addBootstrapLanguages: function() {
      ...
      for (language in languages) {
        if (languages.hasOwnProperty(language)) {
          if (languages[language].hasOwnProperty('name')) {
            if (this.options.flags === true) {
              $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="' + language + '_' + languages[language].country + '"><i class="glyphicon bfh-flag-' + languages[language].country + '"></i>' + languages[language].name.toProperCase() + '</a></li>');
            } else {
              $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="' + language + '_' + languages[language].country + '">' + languages[language].name.toProperCase() + ' (' + BFHCountriesList[languages[language].country] + ')</a></li>');
            }
          } else {
            $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="' + language + '">' + languages[language] + '</a></li>');
          }
        }
      }
  ...
  BFHSelectBox.prototype = {
    ...
    initSelectBox: function () {
      ...
      this.$element.find('div').each(function() {
        options = options + '<li><a tabindex="-1" href="javascript:void(0)" data-option="' + $(this).data('value') + '">' + $(this).html() + '</a></li>';
      });

      this.$element.html(
        '<input type="hidden" id="hiddenCurrencyInputId" name="' + this.options.name + '" value="">' +
		'<a class="bfh-selectbox-toggle ' + this.options.input + '" role="button" data-toggle="bfh-selectbox" href="javascript:void(0)">' +
    ...
    select: function (e) {
      ...
      $("#saveCurrency").attr('value',option);
      
      var symbol=$this.data('symbol');
      $("#saveCurrency").attr('data-symbol',symbol);
...
+function ($) {
  ...
  BFHStates.prototype = {
    ...
    loadBootstrapStates: function(country) {
      ...
      for (state in BFHStatesList[country]) {
        if (BFHStatesList[country].hasOwnProperty(state)) {
          $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="' + BFHStatesList[country][state].code + '">' + BFHStatesList[country][state].name + '</a></li>');
...
+function ($) {
  ...
  BFHTimezones.prototype = {
    ...
    loadBootstrapTimezones: function(country) {
      ...
      for (timezone in BFHTimezonesList[country]) {
        if (BFHTimezonesList[country].hasOwnProperty(timezone)) {
          $options.append('<li><a tabindex="-1" href="javascript:void(0)" data-option="' + timezone + '">' + BFHTimezonesList[country][timezone] + '</a></li>');
        }
      }
